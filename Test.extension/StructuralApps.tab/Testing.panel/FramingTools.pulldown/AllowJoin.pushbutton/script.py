...
t = Transaction(doc, 'Allow Joins on Selected Beams')
t.Start()
    
for b in beams:
    Autodesk.Revit.DB.Structure.StructuralFramingUtils.AllowJoinAtEnd(b,0)
    Autodesk.Revit.DB.Structure.StructuralFramingUtils.AllowJoinAtEnd(b,1)    
t.Commit()